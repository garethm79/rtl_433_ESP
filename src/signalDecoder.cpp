...
void rtlSetup() {
  ...
  if (!cfg->demod) {
    ...
    if (rtl_433_ESP::ookModulation) {
      ...
      memcpy(&cfg->devices[35], &fineoffset_ws85, sizeof(r_device));
      memcpy(&cfg->devices[36], &fineoffset_ws90, sizeof(r_device));
      memcpy(&cfg->devices[38], &flowis, sizeof(r_device));
      memcpy(&cfg->devices[39], &ge_coloreffects, sizeof(r_device));
      memcpy(&cfg->devices[40], &geo_minim, sizeof(r_device));
      memcpy(&cfg->devices[40], &gridstream96, sizeof(r_device));
      memcpy(&cfg->devices[41], &gridstream192, sizeof(r_device));
      memcpy(&cfg->devices[42], &gridstream384, sizeof(r_device));
      memcpy(&cfg->devices[43], &hcs200_fsk, sizeof(r_device));
      memcpy(&cfg->devices[44], &holman_ws5029pcm, sizeof(r_device));
      memcpy(&cfg->devices[45], &holman_ws5029pwm, sizeof(r_device));
      memcpy(&cfg->devices[46], &hondaremote, sizeof(r_device));
      memcpy(&cfg->devices[47], &honeywell_cm921, sizeof(r_device));
      memcpy(&cfg->devices[48], &honeywell_wdb_fsk, sizeof(r_device));
      memcpy(&cfg->devices[49], &ikea_sparsnas, sizeof(r_device));
      memcpy(&cfg->devices[50], &inkbird_ith20r, sizeof(r_device));
      memcpy(&cfg->devices[51], &insteon, sizeof(r_device));
      memcpy(&cfg->devices[52], &lacrosse_breezepro, sizeof(r_device));
      memcpy(&cfg->devices[53], &lacrosse_r1, sizeof(r_device));
      memcpy(&cfg->devices[54], &lacrosse_th3, sizeof(r_device));
      memcpy(&cfg->devices[55], &lacrosse_tx31u, sizeof(r_device));
      memcpy(&cfg->devices[56], &lacrosse_tx34, sizeof(r_device));
      memcpy(&cfg->devices[57], &lacrosse_tx29, sizeof(r_device));
      memcpy(&cfg->devices[58], &lacrosse_tx35, sizeof(r_device));
      memcpy(&cfg->devices[59], &lacrosse_wr1, sizeof(r_device));
      memcpy(&cfg->devices[60], &m_bus_mode_c_t, sizeof(r_device));
      memcpy(&cfg->devices[61], &m_bus_mode_c_t_downlink, sizeof(r_device));
      memcpy(&cfg->devices[62], &m_bus_mode_s, sizeof(r_device));
      memcpy(&cfg->devices[63], &m_bus_mode_r, sizeof(r_device));
      memcpy(&cfg->devices[64], &m_bus_mode_f, sizeof(r_device));
      memcpy(&cfg->devices[65], &marlec_solar, sizeof(r_device));
      memcpy(&cfg->devices[66], &maverick_xr30, sizeof(r_device));
      memcpy(&cfg->devices[67], &maverick_xr50, sizeof(r_device));
      memcpy(&cfg->devices[68], &mueller_hotrod, sizeof(r_device));
      memcpy(&cfg->devices[69], &oil_smart, sizeof(r_device));
      memcpy(&cfg->devices[70], &oil_standard, sizeof(r_device));
      memcpy(&cfg->devices[71], &oil_watchman, sizeof(r_device));
      memcpy(&cfg->devices[72], &oil_watchman_advanced, sizeof(r_device));
      memcpy(&cfg->devices[73], &quinetic, sizeof(r_device));
      memcpy(&cfg->devices[74], &rojaflex, sizeof(r_device));
      memcpy(&cfg->devices[75], &sharp_spc775, sizeof(r_device));
      memcpy(&cfg->devices[76], &simplisafe_gen3, sizeof(r_device));
      memcpy(&cfg->devices[77], &somfy_iohc, sizeof(r_device));
      memcpy(&cfg->devices[78], &srsmith_pool_srs_2c_tx, sizeof(r_device));
      memcpy(&cfg->devices[79], &steelmate, sizeof(r_device));
      memcpy(&cfg->devices[80], &tfa_14_1504_v2, sizeof(r_device));
      memcpy(&cfg->devices[81], &tfa_303196, sizeof(r_device));
      memcpy(&cfg->devices[82], &tfa_marbella, sizeof(r_device));
      memcpy(&cfg->devices[83], &thermopro_tp28b, sizeof(r_device));
      memcpy(&cfg->devices[84], &thermopro_tp828b, sizeof(r_device));
      memcpy(&cfg->devices[85], &thermopro_tp829b, sizeof(r_device));
      memcpy(&cfg->devices[86], &thermopro_tx7b, sizeof(r_device));
      memcpy(&cfg->devices[87], &tpms_abarth124, sizeof(r_device));
      memcpy(&cfg->devices[88], &tpms_ave, sizeof(r_device));
      memcpy(&cfg->devices[89], &tpms_bmw, sizeof(r_device));
      memcpy(&cfg->devices[90], &tpms_bmwg3, sizeof(r_device));
      memcpy(&cfg->devices[91], &tpms_citroen, sizeof(r_device));
      memcpy(&cfg->devices[92], &tpms_elantra2012, sizeof(r_device));
      memcpy(&cfg->devices[93], &tpms_ford, sizeof(r_device));
      memcpy(&cfg->devices[94], &tpms_hyundai_vdo, sizeof(r_device));
      memcpy(&cfg->devices[95], &tpms_jansite, sizeof(r_device));
      memcpy(&cfg->devices[96], &tpms_jansite_solar, sizeof(r_device));
      memcpy(&cfg->devices[97], &tpms_kia, sizeof(r_device));
      memcpy(&cfg->devices[98], &tpms_nissan, sizeof(r_device));
      memcpy(&cfg->devices[99], &tpms_pmv107j, sizeof(r_device));
      memcpy(&cfg->devices[100], &tpms_porsche, sizeof(r_device));
      memcpy(&cfg->devices[101], &tpms_renault, sizeof(r_device));
      memcpy(&cfg->devices[102], &tpms_renault_0435r, sizeof(r_device));
      memcpy(&cfg->devices[103], &tpms_toyota, sizeof(r_device));
      memcpy(&cfg->devices[104], &tpms_truck, sizeof(r_device));
      memcpy(&cfg->devices[105], &vevor_7in1, sizeof(r_device));
    }
